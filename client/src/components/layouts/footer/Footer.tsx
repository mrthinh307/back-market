...
const Footer: React.FC = () => {
  ...
  const footerSections = [
    ...
    },
    {
      title: 'Services',
      links: [
        { label: 'Commercial warranty', href: '/' },
        { label: 'Insurances', href: '/' },
        { label: 'Sell old tech', href: '/' },
        { label: 'Student offer', href: '/' },
        { label: 'Sellers: Register to sell', href: '/' },
        { label: 'Seller portal', href: '/' },
        { label: 'Payments 100% secured', href: '/' },
      ],
    },
    {
      title: 'Resources',
    ...
    },
    {
      ...
      links: [
        ...
        { label: 'Cookies and privacy settings', href: '/' },
        { label: 'Data protection', href: '/' },
        { label: 'Other legal information', href: '/' },
