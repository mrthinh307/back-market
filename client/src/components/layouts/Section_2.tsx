...
const Section2: React.FC = () => {
  return (
    <div className="bg-gradient-to-r from-transparent via-muted-secondary to-transparent pb-12 pt-4 w-full ">
      <h2 className="font-duplet text-2xl mb-6 px-6 text-center font-bold text-foreground">
      ...
      <div className="relative w-full overflow-x-auto scrollbar-none">
        <ul className="flex gap-6 overflow-x-auto px-6 scrollbar-none w-full max-w-none">
          <li className="flex w-40 shrink-0 flex-col items-center gap-2 text-center">
            ...
            <span className="font-duplet text-sm text-foreground">Buttons</span>
          </li>
          <li className="flex w-40 shrink-0 flex-col items-center gap-2 text-center">
            <svg
              aria-hidden="true"
            ...
            <span className="font-duplet text-sm text-foreground">SIM/memory card reader</span>
          </li>
          <li className="flex w-40 shrink-0 flex-col items-center gap-2 text-center">
            <svg
              aria-hidden="true"
            ...
            <span className="font-duplet text-sm text-foreground">Data deletion</span>
          </li>
          <li className="flex w-40 shrink-0 flex-col items-center gap-2 text-center">
            <svg
              aria-hidden="true"
            ...
            <span className="font-duplet text-sm text-foreground">Chargers/cables</span>
          </li>
          <li className="flex w-40 shrink-0 flex-col items-center gap-2 text-center">
            <svg
              aria-hidden="true"
            ...
            <span className="font-duplet text-sm text-foreground">Unlocked by previous owner</span>
          </li>
          <li className="flex w-40 shrink-0 flex-col items-center gap-2 text-center">
            <svg
              aria-hidden="true"
            ...
            <span className="font-duplet text-sm text-foreground">GPS/positioning system</span>
          </li>
          <li className="flex w-40 shrink-0 flex-col items-center gap-2 text-center">
            <svg
              aria-hidden="true"
            ...
            <span className="font-duplet text-sm text-foreground">Cameras</span>
          </li>
          <li className="flex w-40 shrink-0 flex-col items-center gap-2 text-center">
            <svg
              aria-hidden="true"
            ...
            <span className="font-duplet text-sm text-foreground">External sensors</span>
          </li>
          <li className="flex w-40 shrink-0 flex-col items-center gap-2 text-center">
            <svg
              aria-hidden="true"
            ...
            <span className="font-duplet text-sm text-foreground">Biometric sensors</span>
          </li>
          <li className="flex w-40 shrink-0 flex-col items-center gap-2 text-center">
            <svg
              aria-hidden="true"
            ...
            <span className="font-duplet text-sm text-foreground">Wi-Fi and Bluetooth</span>
          </li>
          <li className="flex w-40 shrink-0 flex-col items-center gap-2 text-center">
            <svg
              aria-hidden="true"
            ...
            <span className="font-duplet text-sm text-foreground">IMEI serial number</span>
          </li>
          <li className="flex w-40 shrink-0 flex-col items-center gap-2 text-center">
            <svg
              aria-hidden="true"
            ...
            <span className="font-duplet text-sm text-foreground">Water damage</span>
          </li>
          <li className="flex w-40 shrink-0 flex-col items-center gap-2 text-center">
            <svg
              aria-hidden="true"
            ...
            <span className="font-duplet text-sm text-foreground">Flash and indicator lights</span>
          </li>
          <li className="flex w-40 shrink-0 flex-col items-center gap-2 text-center">
            <svg
              aria-hidden="true"
            ...
            <span className="font-duplet text-sm text-foreground">Mics and speakers</span>
          </li>
          <li className="flex w-40 shrink-0 flex-col items-center gap-2 text-center">
            <svg
              aria-hidden="true"
            ...
            <span className="font-duplet text-sm text-foreground">Input and output ports</span>
          </li>
          <li className="flex w-40 shrink-0 flex-col items-center gap-2 text-center">
            <svg
              aria-hidden="true"
            ...
            <span className="font-duplet text-sm text-foreground">Phone carrier</span>
          </li>
          <li className="flex w-40 shrink-0 flex-col items-center gap-2 text-center">
            <svg
              aria-hidden="true"
            ...
            <span className="font-duplet text-sm text-foreground">Battery health</span>
          </li>
          <li className="flex w-40shrink-0 flex-col items-center gap-2 text-center">
            ...
            <span className="font-duplet text-sm text-foreground">Mechanical parts</span>
          </li>
          <li className="flex w-40 shrink-0 flex-col items-center gap-2 text-center">
            <svg
              aria-hidden="true"
            ...
            <span className="font-duplet text-sm text-foreground">Parts compatibility</span>
          </li>
          <li className="flex w-40 shrink-0 flex-col items-center gap-2 text-center">
            <svg
              aria-hidden="true"
            ...
            <span className="font-duplet text-sm text-foreground">Screen</span>
          </li>
          <li className="flex w-40 shrink-0 flex-col items-center gap-2 text-center">
            <svg
              aria-hidden="true"
            ...
            <span className="font-duplet text-sm text-foreground">Other features specific to this device</span>
          </li>
        </ul>

                {/* gradient overlay bên trái */}
        <div className="pointer-events-none absolute left-0 top-0 h-full w-12 bg-gradient-to-r from-white to-transparent"></div>
