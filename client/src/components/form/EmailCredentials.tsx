...
import facebookIcon from '@/public/assets/images/facebook.svg?url';
import googleIcon from '@/public/assets/images/google-icon.svg?url';
import mailBoxIcon from '@/public/assets/images/mail-box.svg?url';
